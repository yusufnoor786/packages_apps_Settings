...
public class ElixirMaintainerPreferenceController extends BasePreferenceController {
    ...
    public ElixirMaintainerPreferenceController(Context context, String key) {
        super(context, key);
    }
